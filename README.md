...
## Deliverables checklist (per rubric)

- [x] Python notebook — `notebooks/01_spark_eda_and_modelling.ipynb`
- [x] Python scripts — `run_spark_pipeline.py`, `run_pipeline.py`, full `src/`
- [x] Apache Spark / PySpark usage — `src/spark_*.py`, `run_spark_pipeline.py`
- [x] Spark MLlib model — classifier + regressor + ALS recommender
- [x] Recommendation system — ALS + content + hybrid
- [x] Result interpretation — `reports/final_report_outline.md`
- [x] README — this file
- [ ] Slide deck (10 slides) — outline in `reports/final_report_outline.md` § Slide deck mapping
- [ ] Demo video — script in `reports/final_report_outline.md` § Demo video script
